...
Set CRAN repository for installing packages; sometimes the default uses outdated repositories.

```{r options_repos}
options(repos=c(CRAN="https://cran.r-project.org"))
```

Often you need to perform some operation across all pairwise combinations of columns; use `combn()`.
