...
```
    ...
    ## 1 sqrt(x)    349.01ns    373ns  1730913.      848B        0
    ## 2 x^0.5        2.22µs   2.27µs   374960.      848B        0
...
```
    ...
    ## 1 for_loop(my_num)                      2ms   2.1ms      471.    1.69MB    30.2 
    ## 2 map_int(my_num, function(x) x^2)   4.89ms  5.58ms      179.   47.97KB     6.23
    ## 3 sapply(my_num, function(x) x^2)    4.96ms  5.58ms      181.  367.85KB     6.47
