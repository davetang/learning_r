...
```
    ...
    ## 1 sqrt(x)    250.88ns 497.91ns   989901.      848B        0
    ## 2 x^0.5        2.09µs   2.14µs   376518.      848B        0
...
```
    ...
    ## 1 for_loop(my_num)                   2.13ms  2.32ms      421.    1.69MB    19.1 
    ## 2 map_int(my_num, function(x) x^2)    5.2ms  6.29ms      160.   47.97KB     6.49
    ## 3 sapply(my_num, function(x) x^2)    5.29ms   6.3ms      159.  367.85KB     4.18
