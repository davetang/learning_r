-   [Learning R](#learning-r){#toc-learning-r}
    -   [Vectors](#vectors){#toc-vectors}
    -   [Lists](#lists){#toc-lists}
    -   [Objects](#objects){#toc-objects}
    -   [General](#general){#toc-general}
    -   [Useful plots](#useful-plots){#toc-useful-plots}
    -   [Useful tips](#useful-tips){#toc-useful-tips}
        -   [Getting help](#getting-help){#toc-getting-help}
    -   [Hacks](#hacks){#toc-hacks}
        -   [Library paths](#library-paths){#toc-library-paths}
        -   [Variables and
            objects](#variables-and-objects){#toc-variables-and-objects}
    -   [Session info](#session-info){#toc-session-info}
